...
public class history_of_computers extends PApplet {
...
public void histEvent(int x, int y, int w, int h, String title, boolean top, String desc, PImage img )
{
 ...
 */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "history_of_computers" };
    if (passedArgs != null) {
